        ...
        <Layout>
            <div className={styles.container}>
                <div className={styles.header}>
                    <div className={styles.image} style={{backgroundImage: `url(${!isLoading && !isError && data.organizer.poster})`}}></div>
                ...
                <div className={styles.outerContainer}>
                    ...
                    <div className={styles.events_container}>
                        ...
                        {!isLoadingEvents && !isErrorEvents && dataEvents.events.pages > 1 && 
                            <Pagination count={dataEvents.events.pages} size={matches ? 'small' : 'large'} onChange={handlePageChange} className={styles.pagination}/>
                        }
                    </div>
                </div>
            </div>                
